    ...
    public void proximoCliente() {
        ...
        for (int i = 0; i <= this.posFinal; i++) {
            if (peek() == pref) {
                dequeue();
                chamou = 1;
                System.out.printf("\n!__Você chamou o cliente de senha: " + this.idCliente[0]);

                if (pref == true) {
                    System.out.printf(" ele é um cliente preferencial__! \n\n");

                } else {
                    System.out.printf(" ele é um cliente normal__!\n\n");
                }
